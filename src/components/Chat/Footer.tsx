...
export const Footer = ({onSendMessage}: Props) => {
    ...
    const handleStartRecording = async () => {
        ...
        if ("MediaRecorder" in window) {
            try {
                ...
                toast.error("Habilide as permissões de uso do microfone", {position: "top-center"})
                return;
            }
        } else {
    ...
    return (
        <div>
            ...
            {messageAttachment && 
                <div className="flex items-center justify-between text-slate-600 dark:text-sky-400 bg-slate-100/80 dark:bg-slate-900/80 px-10 py-2 border-t">
                    <p className="text-xs">
            ...
            <div className="flex item-center gap-4 border-t bg-slate-100/80 dark:bg-slate-900/80 px-8 py-2.5">
                {isRecording ?
                    <div className="flex items-center gap-5">
                        ...
                        <div className="text-sm text-slate-500 dark:text-slate-300 flex items-center gap-2">
                            <BounceLoader color="f12434b3" size={17} />
